...
- Una **variable aleatoria** es una variable ([lección previa](https://riverorca.com/mod/hvp/view.php?id=224)) cuyos valores son el resultado de un fenómeno aleatorio, como el lanzamiento de un dado o la altura de un grupo de personas.
