...
- Algunas de las distribuciones más comunes incluyen la distribución exponencial, la distribución de Weibull, la distribución gamma, la distribución de Cauchy, entre otras.
...
- Aunque en el curso nos enfocaremos en la distribución normal, veremos que muchas pruebas estadísticas se basan en otras distribuciones, por lo que es útil conocerlas y comprender sus propiedades.
- Algunos de estos ejemplos, don la distribución chi-cuadrada, t de Student, F de Fisher, entre otras, son fundamentales en la inferencia estadística y en el análisis de datos.
