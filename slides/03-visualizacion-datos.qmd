...
Practiquemos un poco más el paquete `ggplot2` para realizar gráficos en R.  En este tutorial vamos a aprender a realizar gráficos de puntos, líneas, barras y áreas utilizando la gramática de los gráficos.
