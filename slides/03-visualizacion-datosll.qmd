...
-  También podemos ver la **simetría** de nuestros daton: si el gráfico de violín es  simétrico, significa que tenemos aproximadamente la misma densidad en ambos lados.
...
- Esto puede ser útil para identificar patrones y asociaciones entre las variables. 
